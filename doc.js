$(function() {
    var ManPageFilter = function(man_content_container, filter_box_relative) {
        var self = this;
        
        this.man_content_container = $(man_content_container);
        this.filter_box_relative = $(filter_box_relative);
         ...
         * 
         * To make the filtering faster (then looping through the dom every
         * time), we'll store all elements and their contents in a simple map
         * and iterate over this one then.
         */
         ...
         * the nodes.
         * 
         * Those are suffixed with stack. The first element [0] is always the root node.
         * 
         * The stack is like a breadcrumb for the current element.
         */
        
        /**
         * Stack contains the dom_element for the parent, which holds
         * all children
         */
        ...
        /**
         * A map, which contains the navigation node, which is connected with an element.
         */
        ...
        for ( var i = 0; i < elements_length; i++) {
            ...
            element_search_texts[i]
                    .push(element_search_texts[navigation_parent_stack[navigation_parent_stack_length - 1]][0]);
        }
        ...
        var checkForSearchChangeHandler = function(event) {
            ...
            if (elements_found === elements_length) {
                ...
                search_result_info.text('Filtered Results: Hiding '
                        + Math.floor(10000 - elements_found * 10000 / elements_length) / 100 + '% (took '
        ...
        $('h1')
                .after(
                        $('<div style="padding: 10px;">This is not the official location of the ' + $('#toctitle').text() + ' API <a href="http://nodejs.org/api.html">nodejs.org/api.html</a>, but an enhanced viewer. Created by <a href="http://dracoblue.net">DracoBlue</a>, 2010.</div>'));
    };
    
    new ManPageFilter('#man-content', '#toctitle');
});
